...
(defmacro defsdl2gfxconstant (name value &optional doc)
...
(defmacro defsdl2gfxenum (name &body enum-list)
...
(defmacro defsdl2gfxtype (name base-type &optional documentation)
  `(eval-when (:compile-toplevel :load-toplevel :execute)
...
(defmacro defsdl2gfxstruct (name &body fields)
...
(defmacro defsdl2gfxunion (name &body fields)
...
(defmacro defsdl2gfxfun ((c-name lisp-name) return-type &body args)
...
(defmacro defsdl2gfx-lispfun (name lambda-list &body body)
